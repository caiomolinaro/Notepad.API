...
namespace UnitTests.Features.Notes.Update;
...
public class UpdateHandlerTest
{
    ...
    public UpdateHandlerTest()
    {
        ...
        _handler = new UpdateHandler(_noteDataMock.Object, _validatorMock.Object);
    }
    ...
    public async Task Handle_WithValidRequest_ReturnResultWithGuid()
    {
        ...
        _noteDataMock.Setup(expression => expression.UpdateNoteAsync(It.IsAny<NoteEntity>(), It.IsAny<CancellationToken>()))
        ...
        _noteDataMock.Verify(expression => expression.UpdateNoteAsync(It.IsAny<NoteEntity>(),
                    It.IsAny<CancellationToken>()), Times.Once);
    }

    [Fact(DisplayName = "Handle With Invalid Request Returns Result With Error")]
    public async Task Handle_WithInvalidRequest_ReturnsResultWithError()
    {
        ...
        _noteDataMock.Verify(expression => expression.UpdateNoteAsync(It.IsAny<NoteEntity>(), It.IsAny<CancellationToken>()), Times.Never);
    }
}